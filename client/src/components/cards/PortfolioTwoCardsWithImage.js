...
const HeadingDescription = tw.p`text-sm md:text-base lg:text-lg font-medium leading-relaxed text-gray-100 mt-8`;
...
const CardHeader = tw.div`text-gray-600 flex justify-between items-center`;
const CardCompany = tw.div`font-bold text-lg`;
...
export default ({
  ...
  headingHtmlComponent = (
    <>
      We've done some <span tw="text-gray-600">amazing projects.</span>
    </>
  ),
