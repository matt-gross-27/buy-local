 ...
 * hocus:bg-gray-700 will apply the bg-gray-700 class on hover or focus
 */
export const NavLink = tw.a`
  text-lg my-2 lg:text-sm lg:mx-6 lg:my-0
  font-semibold tracking-wide transition duration-300
  pb-1 border-b-2 border-transparent hover:border-blue-500 hocus:text-gray-500
`;

export const PrimaryLink = tw(NavLink)`
  lg:mx-0
  px-8 py-3 rounded bg-red-500 text-gray-100
  hocus:bg-gray-700 hocus:text-gray-200 focus:shadow-sm
  border-b-0
`;
...
function HeaderLight ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) {
  /*
